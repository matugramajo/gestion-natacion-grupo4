...
class CoachController extends BaseController {
    ...
    public function store() {
        ...
        try {
            ...
            if ( !$this->coachModel->create( $fields ) ) {
                throw new Exception( 'Error al guardar el perfil del coach.' );
            }

            $this->pdo->commit();

            require_once __DIR__ . '/../services/MailService.php';
            ( new MailService() )->sendWelcomeCoach( $fields['email'], $fields['first_name'], $tempPassword );
